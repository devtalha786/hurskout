...
import visa from '../../public/visa-payment-white.png'
...
export default function Footer() {
  ...
  return (
    <>
      <div className="bg-[#242c3c]  text-white px-3 md:px-5 w-full flex flex-col items-center justify-center gap-y-10">
        <div className="py-7 flex flex-col gap-y-8 md:flex-row items-center justify-between w-[100%] lg:w-[90%] xl:w-[86%] ">
          <h5 className="text-[40px] sm:text-[48px] md:text-[45px] lg:text-[53px] xl:text-[60px] font-extrabold md:w-[50%] text-center">VIND EN REAGEER ALS <span className="bg-[#FF7E4B] text-black p-1 inline-block transform -skew-y-2">EERSTE</span> OP EEN HUUR WONING</h5>
          <Image src={imgboy} className="sm:h-[220px]  lg:h-[280px] xl:h-[300px] sm:w-[380px] lg:w-[430px] xl:w-[450px]"  alt="" />
          {/* <div className="border-b-2 border-white">
            <Image
              src={imgboy}
              className="sm:h-[220px] lg:h-[280px] xl:h-[300px] sm:w-[380px] lg:w-[430px] xl:w-[450px]"
              alt=""
            />
          </div> */}
