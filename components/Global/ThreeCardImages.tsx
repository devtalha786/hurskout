...
export default function ThreeCardImages() {
  return (
    <div className="w-full  py-3 md:pb-10 bg-[#242c3c]  text-white  md:px-5  flex flex-col items-center justify-center gap-y-10">
    <div className="py-7 px-5 sm:px-5 flex flex-col gap-y-8 lg:flex-row items-start lg:items-center lg:justify-around w-[100%] lg:w-[90%] xl:w-[86%] text-white">
      <h5 className="text-[40px] sm:text-[48px] md:text-[45px] lg:text-[60px] font-[900] md:w-[50%]  uppercase ">Wij zijn pas tevreden als <span className="bg-[#FF7E4B] p-1 inline-block transform -skew-y-2">jijdat</span>bent</h5>
