...
export default function Hero() {
    ...
    return (
        ...
        <p className="font-bold md:text-[19px]">{details.loading}</p>

        <button className={`${details.id === 1? 'font-semibold py-2 md:py-3  px-3 md:px-5 rounded-2xl bg-[#51b37e] md:text-lg text-white' : ''}  `}>{details.button}</button>
        </div>
