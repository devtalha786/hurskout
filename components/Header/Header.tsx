...
export default function Header() {
  ...
  return (
    ...
    <nav className='py-6 md:py-9 px-3  md:px-6 w-full bg-[#242c3c] '>
    ...
    <ContactDetail/>
     ...
     <div className={`${menuToggle ? 'right-0' : '-right-[100vh]'}  py-10 border-l-2 border-[#FF7E4B] bg-[#242c3c] fixed z-50 top-0 transition-all duration-300 w-[300px] px-3 h-full flex-col gap-y-24`}>
      ...
      <Link href='/'>         <h6  className='cursor-pointer text-white font-[900]  text-[20px] tracking-wide   hover:text-[#FF7E4B]  mt-3'>MAAR HOE? </h6></Link>
      <Link href='/Reviews'>  <h6  className='cursor-pointer text-white font-[900]  text-[20px] tracking-wide hover:text-[#FF7E4B]  '>REVIEWS</h6></Link>
      <Link href='/Klaar'>    <h6  className='cursor-pointer text-white font-[900]  text-[20px] tracking-wide hover:text-[#FF7E4B]  '>OVER ONS</h6></Link>
      <Link href='/Verifiren'><h6  className='cursor-pointer text-white font-[900]  text-[20px] tracking-wide hover:text-[#FF7E4B]  '>VRAGEN?</h6></Link>
      <Link href='/ContactUs'><h6  className='cursor-pointer text-white font-[900]  text-[20px] tracking-wide hover:text-[#FF7E4B]  '>CONTACT</h6></Link>
