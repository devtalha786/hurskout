...
export default function Activer() {
    return (
        ...
        <div className='px-2 md:px-[20px] my-[140px]'>
            ...
            <div className='lg:flex  my-12 px-4 md:px-8 lg:px-12'>
                <div>
                    <h1 className='text-[26px] my-4 md:text-[30px] lg:text-[40px] font-bold'>Dit gaat er voor jou veranderen</h1>
                    <p className='text-[18px] md:text-[24px]'>Een makelaar voegt een woning toe:</p>

                </div>

                <div className='flex flex-col  mt-5 mb-10 px-5'>
                    <h1 className='text-[30px] font-bold text-left'>Oude manier</h1>
                ...
                <div className='flex flex-col  mt-5 mb-10 px-5'>
                    <h1 className='text-[30px] font-bold text-left'>Huurscout manier</h1>
